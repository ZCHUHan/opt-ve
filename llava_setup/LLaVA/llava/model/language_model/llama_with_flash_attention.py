    ...
    def forward(
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                try:
                    # NOTE:
                    # use_reentrant=False makes checkpointing compatible with
                    # torch.autograd.grad (used by energy-model gradient penalty).
                    ...
                    raise RuntimeError(
                        "Gradient checkpointing for energy training requires "
                        "torch.utils.checkpoint.checkpoint(..., use_reentrant=False). "
                        "Please upgrade PyTorch, or disable gradient checkpointing."
                    ) from e
            else:
